...
export default async function SummaryDetailPage({ params }: PageProps) {
  ...
  return (
    <div>
      ...
      {/* Text Summary */}
      <Card className="mb-4">
        <p className="text-slate-700 leading-relaxed">{data.textSummary}</p>
            ...
            {data.topRatedEntries.map((entry) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-center justify-between py-2 hover:bg-slate-50 rounded px-2 transition-colors"
                >
